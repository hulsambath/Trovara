...
class _MainContentState extends State<_MainContent> with SingleTickerProviderStateMixin {
  ...
  Widget _buildAndroid(BuildContext context) => Scaffold(
    ...
    bottomNavigationBar: BottomNavigationBar(
      ...
      items: const [
        BottomNavigationBarItem(icon: Icon(LucideIcons.notebookPen), label: 'Notes'),
        BottomNavigationBarItem(icon: Icon(LucideIcons.messageCircle), label: 'Chat'),
        BottomNavigationBarItem(icon: Icon(LucideIcons.chartColumn), label: 'Insights'),
        ...
        children: [
          ...
          AnimatedPositioned(
            ...
            child: CNTabBar(
              ...
              onTap: _onTabTapped,
              items: const [
                CNTabBarItem(customIcon: LucideIcons.notebookPen, label: 'Notes'),
                CNTabBarItem(customIcon: LucideIcons.messageCircle, label: 'Chat'),
                CNTabBarItem(customIcon: LucideIcons.chartColumn, label: 'Insights'),
                CNTabBarItem(customIcon: LucideIcons.settings, label: 'Settings'),
              ],
            ),
          ),
        ],
