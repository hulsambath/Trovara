  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider<T>(
      ...
      builder: (context, child) {
        ...
        final content = buildTitle(
          context: context,
          viewModel: viewModel,
          child: builder(context, viewModel, child),
        );

        // Wrap with update banner only if not root (to avoid duplicates in nested providers)
        if (root) {
          return content;
        }
    ...
    child: Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: _buildBannerText(context, updateProvider),
          ),
  ...
  Widget _buildBannerText(BuildContext context, InAppUpdateProvider updateProvider) => Column(
    ...
    children: [
      ...
      Padding(
        ...
        child: Text(
          _getStatusMessage(updateProvider.state),
